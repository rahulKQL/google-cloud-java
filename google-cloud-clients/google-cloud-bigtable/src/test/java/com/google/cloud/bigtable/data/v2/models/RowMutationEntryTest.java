...
public class RowMutationEntryTest {
  ...
  public void serializationTest() throws IOException, ClassNotFoundException {
    ...
    RowMutationEntry underTest =
        RowMutationEntry.create("row-key").setCell(FAMILY, QUALIFIER, timestamp, "fake-values");
  ...
  public void toProtoTest() {
    ...
    RowMutationEntry underTest =
        RowMutationEntry.create(rowKey).setCell(FAMILY, QUALIFIER, timestamp, "fake-values");
